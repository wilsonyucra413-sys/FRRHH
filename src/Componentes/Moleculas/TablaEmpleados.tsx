...
export function TablaEmpleados({ lista }: PropsTabla) {
  if (!lista || lista.length === 0) {
    return <Label texto="No hay empleados para mostrar." />;
  }
  const columnas = Object.keys(lista[0]) as Array<keyof EmpleadoDTO_GET>;
  return (
